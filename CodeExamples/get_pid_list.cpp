...
// Запускается на linux-устройстве и выводит PID'ы текущих процессов в файл
// Использовался как вспомогательная утилита 
// при исследовании состояния физической памяти android-устройства
